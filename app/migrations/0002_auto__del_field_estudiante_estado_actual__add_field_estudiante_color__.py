...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Estudiante.estado_actual'
        db.delete_column('app_estudiante', 'estado_actual')

        # Adding field 'Estudiante.color'
        db.add_column('app_estudiante', 'color',
                      self.gf('django.db.models.fields.IntegerField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Estudiante.estado_institucion'
        db.add_column('app_estudiante', 'estado_institucion',
                      self.gf('django.db.models.fields.IntegerField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Estudiante.estado_actual'
        db.add_column('app_estudiante', 'estado_actual',
                      self.gf('django.db.models.fields.IntegerField')(max_length=255, null=True),
                      keep_default=False)

        # Deleting field 'Estudiante.color'
        db.delete_column('app_estudiante', 'color')

        # Deleting field 'Estudiante.estado_institucion'
        db.delete_column('app_estudiante', 'estado_institucion')
