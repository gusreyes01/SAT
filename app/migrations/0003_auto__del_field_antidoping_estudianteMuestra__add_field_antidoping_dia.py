...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Antidoping.estudianteMuestra'
        db.delete_column('app_antidoping', 'estudianteMuestra')

        # Adding field 'Antidoping.dia'
        db.add_column('app_antidoping', 'dia',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


        # Changing field 'Antidoping.muestra_fin'
        db.alter_column('app_antidoping', 'muestra_fin', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Antidoping.muestra_inicio'
        db.alter_column('app_antidoping', 'muestra_inicio', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):
        # Adding field 'Antidoping.estudianteMuestra'
        db.add_column('app_antidoping', 'estudianteMuestra',
                      self.gf('django.db.models.fields.IntegerField')(max_length=255, null=True),
                      keep_default=False)

        # Deleting field 'Antidoping.dia'
        db.delete_column('app_antidoping', 'dia')
        ...
        # Changing field 'Antidoping.muestra_inicio'
        db.alter_column('app_antidoping', 'muestra_inicio', self.gf('django.db.models.fields.DateField')(max_length=255, null=True))
