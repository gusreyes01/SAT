...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('app_antidoping', (
            ...
            ('muestra_fin', self.gf('django.db.models.fields.DateField')(max_length=255, null=True)),
        ...
        db.create_table('app_encuesta', (
            ...
            ('estudiante_resultado', self.gf('django.db.models.fields.related.ForeignKey')(related_name='estudiante_resultado', null=True, to=orm['app.EstudianteResultado'])),
        ))
    ...
    models = {
        ...
        'app.encuesta': {
            ...
            'estudiante_resultado': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'estudiante_resultado'", 'null': 'True', 'to': "orm['app.EstudianteResultado']"}),
