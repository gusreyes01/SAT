...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('app_estudiante', (
            ...
            ('estado_actual', self.gf('django.db.models.fields.IntegerField')(max_length=255, null=True)),
        ))
        ...
        db.create_table('app_grupo', (
            ...
            ('crn', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Clase'])),
            ('horario', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('salon', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('profesor', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('cantidad_alumnos', self.gf('django.db.models.fields.IntegerField')(max_length=255, null=True)),
        ))
        ...
        db.create_table('app_inscrito', (
            ...
            ('grupo', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        ...
        db.create_table('app_antidoping', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('muestra_inicio', self.gf('django.db.models.fields.DateField')(default=datetime.date.today)),
            ('muestra_fin', self.gf('django.db.models.fields.DateField')(max_length=255)),
            ('estudianteMuestra', self.gf('django.db.models.fields.IntegerField')(max_length=255, null=True)),
    ...
    models = {
        'app.antidoping': {
            ...
            'muestra_fin': ('django.db.models.fields.DateField', [], {'max_length': '255'}),
        ...
        'app.estudiante': {
            ...
            'estado_actual': ('django.db.models.fields.IntegerField', [], {'max_length': '255', 'null': 'True'}),
